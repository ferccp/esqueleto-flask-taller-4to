...
def formulario_modificar_solicitud_compras(id_solicitud):
		...
		return render_template('formulario-modificar-solicitud-de-compras.html',estados = [ { 'id':item['id'], 'descripcion': item['descripcion']} for item in estado.getEsatdo() if item['descripcion'] in ("PENDIENTE")] , \
